...
config = BertConfig.from_pretrained('./pretrained_model/bert-base-uncased-config.json', num_labels=2)
...
data.to_csv('../data/test_copy.csv', index=False)
